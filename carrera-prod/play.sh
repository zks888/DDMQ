...
docker run -it --rm -p 127.0.0.1:8080:8080 --add-host=mysql:192.168.1.11 --name ddmq ddmq:n01

# run ddmq container
echo 'start ddmq container n02.'
docker run -it --rm -p 127.0.0.1:8081:8080 --add-host=mysql:192.168.1.11 --name ddmq ddmq:n02
